...
latex_documents = [
    (master_doc, 'UPduino.tex', 'UPduino Documentation',
     'Venkat Rangan', 'manual'),
]
...
man_pages = [
    (master_doc, 'upduino', 'UPduino Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'UPduino', 'UPduino Documentation',
     author, 'UPduino', 'Documentation pertaining to the UPduino',
     'Miscellaneous'),
]
