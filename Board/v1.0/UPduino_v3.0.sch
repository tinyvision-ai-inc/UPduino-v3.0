...
U 1 1 5DE47626
P 12850 8650
F 0 "#PWR068" H 12850 8400 50  0001 C CNN
...
U 1 1 5E1AA431
P 4800 8150
F 0 "TP12" V 4800 8350 50  0000 L CNN
F 1 "TestPoint" V 4845 8338 50  0001 L CNN
F 2 "TestPoint:TestPoint_Pad_D1.0mm" H 5000 8150 50  0001 C CNN
...
U 2 1 5E044C02
P 6900 7850
F 0 "U8" H 6875 7583 50  0000 C CNN
F 1 "SN74AUP2G125DCUR" H 7350 8000 50  0000 C CNN
F 2 "Package_SO:VSSOP-8_2.3x2mm_P0.5mm" H 6900 7850 50  0001 C CNN
F 3 "http://www.ti.com/lit/sg/scyt129e/scyt129e.pdf" H 6900 7850 50  0001 C CNN
	2    6900 7850
	1    0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 5E39536F
P 10300 1250
F 0 "R16" V 10507 1250 50  0000 C CNN
F 1 "JUMPER" V 10416 1250 50  0000 C CNN
F 2 "vs:SolderJumper-2_0603_Open_TrianglePad1.0x1.5mm" V 10230 1250 50  0001 C CNN
...
U 1 1 5E1AA337
P 4800 7950
F 0 "TP11" V 4800 8150 50  0000 L CNN
F 1 "TestPoint" V 4845 8138 50  0001 L CNN
F 2 "TestPoint:TestPoint_Pad_D1.0mm" H 5000 7950 50  0001 C CNN
...
Wire Wire Line
	6350 7850 6600 7850
Text Notes 6150 8650 0    50   ~ 0
FTDI UART operation\n- SPI is active (ICE_SS is low), UART is inoperative\n  User should not drive IOB_22A!\n- SPI is inactive (ICE_SS is high)\n  ICE_SCK, MOSI, MISO are isolated\n  FTDI talks to IOB_22A/23B
$Comp
L UPduino_v3.0:Device_R R11
U 1 1 5EC8D75E
P 11650 1850
F 0 "R11" V 11857 1850 50  0000 C CNN
F 1 "JUMPER" V 11766 1850 50  0000 C CNN
F 2 "vs:SolderJumper-2_0603_Open_TrianglePad1.0x1.5mm" V 11580 1850 50  0001 C CNN
...
U 1 1 5EC8DAD9
P 11650 1950
F 0 "R12" V 11857 1950 50  0000 C CNN
F 1 "JUMPER" V 11766 1950 50  0000 C CNN
F 2 "vs:SolderJumper-2_0603_Open_TrianglePad1.0x1.5mm" V 11580 1950 50  0001 C CNN
F 3 "~" H 11650 1950 50  0001 C CNN
	1    11650 1950
	0    1    1    0   
$EndComp
Wire Wire Line
	11900 1550 12750 1550
Wire Wire Line
	11800 1850 12750 1850
Wire Wire Line
	11800 1950 12750 1950
Wire Wire Line
	11450 1250 11450 1450
Wire Wire Line
	10450 1250 11450 1250
Wire Wire Line
	11450 1450 12750 1450
$Comp
L Power_Protection:USBLC6-2SC6 U9
U 1 1 5ED9CA8A
P 1200 6800
F 0 "U9" V 1050 7150 50  0000 L CNN
F 1 "USBLC6-2SC6" V 1300 7150 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23-6" H 450 7200 50  0001 C CNN
F 3 "http://www2.st.com/resource/en/datasheet/CD00050750.pdf" H 1400 7150 50  0001 C CNN
	1    1200 6800
	0    1    1    0   
$EndComp
...
USB_M
$Comp
L UPduino_v3.0:power_GND #PWR015
U 1 1 5EDA12B0
P 700 6800
F 0 "#PWR015" H 700 6550 50  0001 C CNN
